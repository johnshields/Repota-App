...
These paths are all managed in routers.go. The API's main function boots up these 'routers' after the essential CORS requirements have been set (Figure 4.12). Table 4.1 displays the handler functions and their paths.  
